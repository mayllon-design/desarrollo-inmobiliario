...
import { Building, Briefcase, Wrench, RefreshCcw } from "lucide-react";

const useCases = [
  {
    icon: Briefcase,
    title: "Complemento bancario",
    description: "Banco financia obra, pero no IGV, acabados o contingencias. Cubrimos el gap.",
    tag: "Top-up / Mezzanine"
  },
  {
    icon: Building,
    title: "Pre-banca",
    description: "Proyecto aún no calza en banca, pero el activo es sólido. Capital para arrancar.",
    tag: "Capital inicial"
  },
  {
    icon: RefreshCcw,
      ...
      <div className="container mx-auto px-6">
        ...
        >
          ...
          <h2 className="font-display text-3xl md:text-5xl font-bold mb-4">
            Estructuras que <span className="text-gradient-gold">resuelven</span>
          </h2>
          <p className="text-muted-foreground font-body max-w-2xl mx-auto">
            No hablamos de "urgencia" sino de gestión financiera inteligente. 
            Cada estructura se diseña según el activo, flujo y ciclo del proyecto.
          </p>
        </motion.div>
