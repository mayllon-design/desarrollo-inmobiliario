      ...
      <div className="container mx-auto px-6">
        ...
        >
          ...
          <h2 className="font-display text-3xl md:text-5xl font-bold mb-4">
            Financiamiento <span className="text-gradient-gold">estructurado</span>
          </h2>
          ...
          >
            ...
            <ul className="space-y-4">
              {[
                ...
                "Solución de capital basada en activos",
                "Instrumento de corto/mediano plazo",
                "Complemento, alternativa o pre-banca",
                "Estructura alineada al flujo del proyecto"
              ].map((item, index) => (
                <motion.li
                  key={item}
          ...
          >
            ...
            <ul className="space-y-4">
              {[
                ...
                "Financiamiento estándar de estantería",
