...
import { FileSearch, Calculator, Scale, FileText, CheckCircle, Banknote } from "lucide-react";
...
const steps = [
  ...
  },
  {
    ...
    icon: Calculator,
    title: "Diagnóstico",
    description: "Análisis de viabilidad financiera y coherencia del flujo del proyecto."
  },
  {
    number: "03",
    icon: Scale,
  ...
  },
  {
    ...
    description: "Diseño del financiamiento: monto, plazo, esquema de pagos y condiciones."
  },
  {
    number: "05",
    icon: CheckCircle,
    title: "Term Sheet",
    description: "Aprobación del fondo y presentación de condiciones al desarrollador."
  },
  {
    number: "06",
    icon: Banknote,
          ...
          {steps.map((step, index) => (
            ...
            >
              ...
              <div className={`flex-1 ${index % 2 === 0 ? 'md:text-right md:pr-12' : 'md:text-left md:pl-12'}`}>
                <div className={`p-6 rounded-xl bg-gradient-card border border-border hover:border-secondary/30 transition-all duration-300 ${
